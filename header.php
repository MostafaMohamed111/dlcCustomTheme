                    ...
                    <div class="language-changer language-changer-desktop">
                        ...
                        if (is_category() || is_archive()) {
                            ...
                            if (isset($queried_object->slug)) {
                                ...
                                } elseif (strpos($slug, 'home-international') !== false && strpos($slug, '-ar') === false) {
                                    $is_services_page = true;
                            ...
                            foreach ($post_categories as $cat) {
                                if (strpos($cat->slug, 'companies-services') !== false && strpos($cat->slug, '-ar') === false) {
                                    ...
                                    $service_type = 'individual';
                                    break;
                                } elseif (strpos($cat->slug, 'home-international') !== false && strpos($cat->slug, '-ar') === false) {
                                    $is_services_page = true;
                                    $service_type = 'home-international';
                                    break;
                                }
                        ...
                        elseif ($is_services_page && $service_type) {
                            ...
                            if ($service_type === 'individual') {
                                $slug = 'individual-services-ar';
                            } elseif ($service_type === 'home-international') {
                                $slug = 'home-international-ar';
                            } else {
                                $slug = 'companies-services-ar';
                            }
